...
parser = argparse.ArgumentParser(description="Converts TF SavedModel to the TensorRT enabled grap.")

parser.add_argument("--input_model_dir", required=True)
parser.add_argument("--output_model_dir", required=True)
parser.add_argument("--batch_size", type=int, required=True)
parser.add_argument("--precision_mode", choices=["FP32", "FP16", "INT8", "INT4"], required=True)
